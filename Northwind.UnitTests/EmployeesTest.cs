...
namespace Northwind.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="EmployeesTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  Employees objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Employees CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Employees mock = EmployeesTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Employees mock)
        {
        ...
        static private void SetSpecialTestData(Employees mock)
        {
