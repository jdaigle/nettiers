...
namespace Northwind.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CustomersTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  Customers objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Customers CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Customers mock = CustomersTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Customers mock)
        {
            CustomersTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Customers mock)
        {
