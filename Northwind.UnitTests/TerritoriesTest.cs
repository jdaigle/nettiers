...
namespace Northwind.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TerritoriesTest"/> instance.
		/// </summary>	
		public TerritoriesTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Territories objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Territories CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Territories mock = TerritoriesTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Territories mock)
        {
        ...
        static private void SetSpecialTestData(Territories mock)
        {
