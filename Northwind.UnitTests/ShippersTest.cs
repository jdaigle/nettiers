...
namespace Northwind.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ShippersTest"/> instance.
		/// </summary>	
		public ShippersTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Shippers objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Shippers CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Shippers mock = ShippersTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Shippers mock)
        {
        ...
        static private void SetSpecialTestData(Shippers mock)
        {
