...
namespace Northwind.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductsTest"/> instance.
		/// </summary>	
		public ProductsTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Products objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Products CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Products mock = ProductsTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Products mock)
        {
        ...
        static private void SetSpecialTestData(Products mock)
        {
