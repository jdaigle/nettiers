...
{
    /// <summary>
    /// Provides tests for the and <see cref="Suppliers"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
	/// This file is generated once and will never be overwritten.
	/// </remarks>
    [TestFixture]
    public partial class SuppliersTest
    {    	
		/// <summary>
		/// Creates a new <see cref="SuppliersTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Inserts a mock Suppliers entity into the database.
		/// </summary>
		...
		/// <summary>
		/// Selects a sample of  Suppliers objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Updates a mock Suppliers entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize the mock Suppliers entity from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize a Suppliers collection from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Suppliers CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Suppliers mock = SuppliersTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Suppliers mock)
        {
        ...
        static private void SetSpecialTestData(Suppliers mock)
        {
