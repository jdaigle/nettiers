...
namespace Northwind.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="OrdersTest"/> instance.
		/// </summary>	
		public OrdersTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Orders objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Orders CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Orders mock = OrdersTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Orders mock)
        {
            OrdersTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Orders mock)
        {
