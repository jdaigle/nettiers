...
{
    /// <summary>
    /// Provides tests for the <see cref="Invoices"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="InvoicesTest"/> instance.
		/// </summary>	
		public InvoicesTest()
		{			
		}
		...
		/// <summary>
		/// Selects all Invoices objects of the database.
		/// </summary>
