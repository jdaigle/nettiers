...
{
    /// <summary>
    /// Provides tests for the <see cref="CustomerAndSuppliersByCity"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="CustomerAndSuppliersByCityTest"/> instance.
		/// </summary>	
		public CustomerAndSuppliersByCityTest()
		{			
		}
		...
		/// <summary>
		/// Selects all CustomerAndSuppliersByCity objects of the database.
		/// </summary>
