...
{
    /// <summary>
    /// Provides tests for the <see cref="OrderSubtotals"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="OrderSubtotalsTest"/> instance.
		/// </summary>	
		public OrderSubtotalsTest()
		{			
		}
		...
		/// <summary>
		/// Selects all OrderSubtotals objects of the database.
		/// </summary>
