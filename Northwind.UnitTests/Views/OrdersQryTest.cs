...
{
    /// <summary>
    /// Provides tests for the <see cref="OrdersQry"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="OrdersQryTest"/> instance.
		/// </summary>	
		public OrdersQryTest()
		{			
		}
		...
		/// <summary>
		/// Selects all OrdersQry objects of the database.
		/// </summary>
