...
{
    /// <summary>
    /// Provides tests for the <see cref="ProductsAboveAveragePrice"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ProductsAboveAveragePriceTest"/> instance.
		/// </summary>	
		public ProductsAboveAveragePriceTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ProductsAboveAveragePrice objects of the database.
		/// </summary>
