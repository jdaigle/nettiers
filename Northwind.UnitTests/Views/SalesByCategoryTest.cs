...
{
    /// <summary>
    /// Provides tests for the <see cref="SalesByCategory"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="SalesByCategoryTest"/> instance.
		/// </summary>	
		public SalesByCategoryTest()
		{			
		}
		...
		/// <summary>
		/// Selects all SalesByCategory objects of the database.
		/// </summary>
