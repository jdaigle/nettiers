/*
	...
	Important: Do not modify this file. Edit the file ProductSalesFor1997.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'Product Sales for 1997' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ProductSalesFor1997Base")]
	public abstract partial class ProductSalesFor1997Base : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		///</summary>
		public ProductSalesFor1997Base()
		{
		}		
		...
		{
			get { return "Product Sales for 1997"; }
		}
		...
		///<returns>true if toObject is a <see cref="ProductSalesFor1997Base"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ProductSalesFor1997Base toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ProductSalesFor1997Base"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ProductSalesFor1997Base"/> to compare.</param>
		///<param name="Object2">The second <see cref="ProductSalesFor1997Base"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ProductSalesFor1997Base Object1, ProductSalesFor1997Base Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		{			
			return GetPropertyValueByName(this as ProductSalesFor1997, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{4}{3}- CategoryName: {0}{3}- ProductName: {1}{3}- ProductSales: {2}{3}", 
				this.CategoryName,
				this.ProductName,
	...
	/// <summary>
	/// Enumerate the ProductSalesFor1997 columns.
	/// </summary>
	[Serializable]
	public enum ProductSalesFor1997Column
	{
		/// <summary>
		/// CategoryName : 
		/// </summary>
