...
{
	///<summary>
	/// An object representation of the 'Summary of Sales by Quarter' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	...
	public abstract partial class SummaryOfSalesByQuarterBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		///</summary>
		public SummaryOfSalesByQuarterBase()
		{
		}		
		...
		{
			get { return "Summary of Sales by Quarter"; }
		}
		...
		///<returns>true if toObject is a <see cref="SummaryOfSalesByQuarterBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(SummaryOfSalesByQuarterBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="SummaryOfSalesByQuarterBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="SummaryOfSalesByQuarterBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="SummaryOfSalesByQuarterBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(SummaryOfSalesByQuarterBase Object1, SummaryOfSalesByQuarterBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		{			
			return GetPropertyValueByName(this as SummaryOfSalesByQuarter, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the SummaryOfSalesByQuarter columns.
	/// </summary>
	[Serializable]
	public enum SummaryOfSalesByQuarterColumn
	{
		/// <summary>
		/// ShippedDate : 
		/// </summary>
