...
/*
	...
	Important: Do not modify this file. Edit the file SqlRegionProvider.cs instead.
*/
...
namespace Northwind.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlRegionProviderBase : RegionProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlRegionProviderBase"/> instance.
		/// </summary>
		public SqlRegionProviderBase()
		{
		}
	...
	public SqlRegionProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _regionId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Region)
					,_regionId);
		...
		public override TList<Region> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@RegionDescription", DbType.StringFixedLength, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("regiondescription ") || clause.Trim().StartsWith("regiondescription="))
				{
					database.SetParameterValue(commandWrapper, "@RegionDescription", 
			...
			//Create Collection
			TList<Region> rows = new TList<Region>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Northwind.Entities.Region objects.</returns>
		public override TList<Region> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override Northwind.Entities.Region GetByRegionId(TransactionManager transactionManager, System.Int32 _regionId, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<Region> tmp = new TList<Region>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByRegionId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByRegionId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Northwind.Entities.Region> entities)
		{
			...
			DataColumn col0 = dataTable.Columns.Add("RegionID", typeof(System.Int32));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("RegionDescription", typeof(System.String));
			col1.AllowDBNull = false;		
			
			bulkCopy.ColumnMappings.Add("RegionID", "RegionID");
			bulkCopy.ColumnMappings.Add("RegionDescription", "RegionDescription");
			
			foreach(Northwind.Entities.Region entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["RegionDescription"] = entity.RegionDescription;
