...
/*
	...
	Important: Do not modify this file. Edit the file SqlEmployeeTerritoriesProvider.cs instead.
*/
...
namespace Northwind.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlEmployeeTerritoriesProviderBase : EmployeeTerritoriesProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlEmployeeTerritoriesProviderBase"/> instance.
		/// </summary>
		public SqlEmployeeTerritoriesProviderBase()
		{
		}
	...
	public SqlEmployeeTerritoriesProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _employeeId, System.String _territoryId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(EmployeeTerritories)
					,_employeeId,_territoryId);
		...
		public override TList<EmployeeTerritories> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@TerritoryId", DbType.String, DBNull.Value);
			...
			//Create Collection
			TList<EmployeeTerritories> rows = new TList<EmployeeTerritories>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Northwind.Entities.EmployeeTerritories objects.</returns>
		public override TList<EmployeeTerritories> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		#region GetByEmployeeIdTerritoryId
		...
		public override Northwind.Entities.EmployeeTerritories GetByEmployeeIdTerritoryId(TransactionManager transactionManager, System.Int32 _employeeId, System.String _territoryId, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<EmployeeTerritories> tmp = new TList<EmployeeTerritories>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByEmployeeIdTerritoryId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByEmployeeIdTerritoryId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Northwind.Entities.EmployeeTerritories> entities)
		{
			...
			bulkCopy.DestinationTableName = "EmployeeTerritories";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("EmployeeID", typeof(System.Int32));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("TerritoryID", typeof(System.String));
			col1.AllowDBNull = false;		
			
			bulkCopy.ColumnMappings.Add("EmployeeID", "EmployeeID");
			bulkCopy.ColumnMappings.Add("TerritoryID", "TerritoryID");
			
			foreach(Northwind.Entities.EmployeeTerritories entity in entities)
			{
