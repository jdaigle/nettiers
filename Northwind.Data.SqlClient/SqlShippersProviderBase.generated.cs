...
/*
	...
	Important: Do not modify this file. Edit the file SqlShippersProvider.cs instead.
*/
...
namespace Northwind.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlShippersProviderBase : ShippersProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlShippersProviderBase"/> instance.
		/// </summary>
		public SqlShippersProviderBase()
		{
		}
	...
	public SqlShippersProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _shipperId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Shippers)
					,_shipperId);
		...
		public override TList<Shippers> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@ShipperId", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Phone", DbType.String, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("shipperid ") || clause.Trim().StartsWith("shipperid="))
				{
					database.SetParameterValue(commandWrapper, "@ShipperId", 
			...
			//Create Collection
			TList<Shippers> rows = new TList<Shippers>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Northwind.Entities.Shippers objects.</returns>
		public override TList<Shippers> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override Northwind.Entities.Shippers GetByShipperId(TransactionManager transactionManager, System.Int32 _shipperId, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<Shippers> tmp = new TList<Shippers>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByShipperId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByShipperId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Northwind.Entities.Shippers> entities)
		{
			...
			DataColumn col0 = dataTable.Columns.Add("ShipperID", typeof(System.Int32));
			...
			bulkCopy.ColumnMappings.Add("ShipperID", "ShipperID");
			bulkCopy.ColumnMappings.Add("CompanyName", "CompanyName");
			bulkCopy.ColumnMappings.Add("Phone", "Phone");
			
			foreach(Northwind.Entities.Shippers entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["ShipperID"] = entity.ShipperId;
		...
		public override bool Insert(TransactionManager transactionManager, Northwind.Entities.Shippers entity)
		{
			...
			object _shipperId = database.GetParameterValue(commandWrapper, "@ShipperId");
			entity.ShipperId = (System.Int32)_shipperId;
