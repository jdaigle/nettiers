...
/*
	...
	Important: Do not modify this file. Edit the file SqlCustomerCustomerDemoProvider.cs instead.
*/
...
namespace Northwind.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlCustomerCustomerDemoProviderBase : CustomerCustomerDemoProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlCustomerCustomerDemoProviderBase"/> instance.
		/// </summary>
		public SqlCustomerCustomerDemoProviderBase()
		{
		}
	...
	public SqlCustomerCustomerDemoProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _customerId, System.String _customerTypeId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(CustomerCustomerDemo)
					,_customerId,_customerTypeId);
		...
		public override TList<CustomerCustomerDemo> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@CustomerTypeId", DbType.StringFixedLength, DBNull.Value);
			...
			//Create Collection
			TList<CustomerCustomerDemo> rows = new TList<CustomerCustomerDemo>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Northwind.Entities.CustomerCustomerDemo objects.</returns>
		public override TList<CustomerCustomerDemo> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override TList<CustomerCustomerDemo> GetByCustomerTypeId(TransactionManager transactionManager, System.String _customerTypeId, int start, int pageLength, out int count)
		{
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByCustomerTypeId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByCustomerTypeId", rows)); 
			}
			finally
			{
				if (reader != null) 
		...
		#region GetByCustomerIdCustomerTypeId
		...
		public override Northwind.Entities.CustomerCustomerDemo GetByCustomerIdCustomerTypeId(TransactionManager transactionManager, System.String _customerId, System.String _customerTypeId, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<CustomerCustomerDemo> tmp = new TList<CustomerCustomerDemo>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByCustomerIdCustomerTypeId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByCustomerIdCustomerTypeId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Northwind.Entities.CustomerCustomerDemo> entities)
		{
			...
			bulkCopy.DestinationTableName = "CustomerCustomerDemo";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("CustomerID", typeof(System.String));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("CustomerTypeID", typeof(System.String));
			col1.AllowDBNull = false;		
			
			bulkCopy.ColumnMappings.Add("CustomerID", "CustomerID");
			bulkCopy.ColumnMappings.Add("CustomerTypeID", "CustomerTypeID");
			
			foreach(Northwind.Entities.CustomerCustomerDemo entity in entities)
			{
