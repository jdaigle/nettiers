...
/// </summary>
public abstract partial class SqlSalesTotalsByAmountProviderBase : SalesTotalsByAmountProviderBase
{
	...
	/// <summary>
	/// Creates a new <see cref="SqlSalesTotalsByAmountProviderBase"/> instance.
	/// Uses connection string to connect to datasource.
	/// </summary>
	protected SqlSalesTotalsByAmountProviderBase()
	{		
	}
	...
	public SqlSalesTotalsByAmountProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
	...
	public override VList<SalesTotalsByAmount> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
	{
		...
		//Create Collection
		VList<SalesTotalsByAmount> rows = new VList<SalesTotalsByAmount>();
	...
	/// <returns>Returns a typed collection of SalesTotalsByAmount objects.</returns>
	public override VList<SalesTotalsByAmount> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
	{
