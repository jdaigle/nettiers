...
/// </summary>
public abstract partial class SqlSalesByCategoryProviderBase : SalesByCategoryProviderBase
{
	...
	/// <summary>
	/// Creates a new <see cref="SqlSalesByCategoryProviderBase"/> instance.
	/// Uses connection string to connect to datasource.
	/// </summary>
	protected SqlSalesByCategoryProviderBase()
	{		
	}
	...
	public SqlSalesByCategoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
	...
	public override VList<SalesByCategory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
	{
		...
		//Create Collection
		VList<SalesByCategory> rows = new VList<SalesByCategory>();
	...
	/// <returns>Returns a typed collection of SalesByCategory objects.</returns>
	public override VList<SalesByCategory> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
	{
