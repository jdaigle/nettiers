...
/*
	...
	Important: Do not modify this file. Edit the file SqlCustomerDemographicsProvider.cs instead.
*/
...
namespace Northwind.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlCustomerDemographicsProviderBase : CustomerDemographicsProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlCustomerDemographicsProviderBase"/> instance.
		/// </summary>
		public SqlCustomerDemographicsProviderBase()
		{
		}
	...
	public SqlCustomerDemographicsProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<CustomerDemographics> GetByCustomerIdFromCustomerCustomerDemo(TransactionManager transactionManager, System.String _customerId, int start, int pageLength, out int count)
		{
			...
			TList<CustomerDemographics> rows = new TList<CustomerDemographics>();
			
			try
			{
				// Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByCustomerIdFromCustomerCustomerDemo", rows)); 
				...
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByCustomerIdFromCustomerCustomerDemo", rows)); 
		...
		public override bool Delete(TransactionManager transactionManager, System.String _customerTypeId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(CustomerDemographics)
					,_customerTypeId);
		...
		public override TList<CustomerDemographics> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
		...
		database.AddInParameter(commandWrapper, "@CustomerTypeId", DbType.StringFixedLength, DBNull.Value);
		database.AddInParameter(commandWrapper, "@CustomerDesc", DbType.String, DBNull.Value);
			...
			{
				if (clause.Trim().StartsWith("customertypeid ") || clause.Trim().StartsWith("customertypeid="))
				{
					database.SetParameterValue(commandWrapper, "@CustomerTypeId", 
						clause.Trim().Remove(0,14).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("customerdesc ") || clause.Trim().StartsWith("customerdesc="))
				{
					database.SetParameterValue(commandWrapper, "@CustomerDesc", 
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Northwind.Entities.CustomerDemographics objects.</returns>
		public override TList<CustomerDemographics> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
		...
		public override Northwind.Entities.CustomerDemographics GetByCustomerTypeId(TransactionManager transactionManager, System.String _customerTypeId, int start, int pageLength, out int count)
		{
			...
			IDataReader reader = null;
			TList<CustomerDemographics> tmp = new TList<CustomerDemographics>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByCustomerTypeId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByCustomerTypeId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Northwind.Entities.CustomerDemographics> entities)
		{
			...
			bulkCopy.DestinationTableName = "CustomerDemographics";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("CustomerTypeID", typeof(System.String));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("CustomerDesc", typeof(System.String));
			col1.AllowDBNull = true;		
			
			bulkCopy.ColumnMappings.Add("CustomerTypeID", "CustomerTypeID");
			bulkCopy.ColumnMappings.Add("CustomerDesc", "CustomerDesc");
			
			foreach(Northwind.Entities.CustomerDemographics entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["CustomerTypeID"] = entity.CustomerTypeId;
							
				
					row["CustomerDesc"] = entity.CustomerDesc;
		...
		public override bool Insert(TransactionManager transactionManager, Northwind.Entities.CustomerDemographics entity)
		{
			...
			entity.OriginalCustomerTypeId = entity.CustomerTypeId;
